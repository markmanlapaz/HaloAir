---
label: "Water Heaters"
short: "Tank, tankless, repair, replace — one Red Seal crew handles it all."
metaTitle: "Water Heater Service Edmonton — Repair, Install, Tankless | Halo Air"
metaDesc: "Edmonton water heater repair, tank installation, and tankless conversions. Red Seal Plumber + Gasfitter on every job — gas, venting, and plumbing handled by one crew. Free estimate on new installs. Call 780-224-0024."
h1: "Water heaters — quick fixes, clean swaps, tankless if you want it."
icon: "tools"
accent: "blue"
...
faq:
  ...
  - q: "How fast can you get to a leaking water heater?"
    a: "We treat leaking water heaters as priority calls during business hours and after-hours service is available on request. A leak from the tank body (not a fitting) means replacement is overdue — we'll get the new unit ordered and stop the active damage immediately."
  - q: "Do you handle gas-line work too?"
    a: "Yes. The owner holds a Journeyman Gasfitter ticket alongside the Red Seal Plumber ticket. New gas runs, repositioning, pressure-testing — all done by the same crew. Most water heater swaps need at least minor gas work (sediment trap, drip leg, sometimes a venting change), and we don't sub it out."
order: 30
---

## Three water-heater services, one crew

Water-heater repair, water-heater installation, and tankless installs / conversions — handled end-to-end. Most contractors split this work across a plumber and a gasfitter (or a plumber and a sub-contracted gasfitter). Halo Air does both, and the warranty is signed by one company.

## What "fully installed" means here

Most water-heater quotes leave out half the actual job. A proper install quote includes the equipment itself, removal and disposal of the old unit, all new fittings (sometimes including expansion tank and dielectric unions, both required by current Alberta code), gas-line connection with leak test, venting modifications (often required when swapping tank types), pressure-relief valve discharge piping, and a permit pulled with your municipality. If a quote skips any of these, you're getting a teaser — ask for a written itemized estimate.
